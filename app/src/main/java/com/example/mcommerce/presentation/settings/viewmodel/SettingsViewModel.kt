    ...
    override fun invokeActions(action: SettingsContract.Action) {
        when (action) {
            is SettingsContract.Action.ClickOnCheckButton -> {
                _events.value =
                    if (action.isChecked) SettingsContract.Events.UnCheckDarkMode else SettingsContract.Events.CheckDarkMode
            }
                ...
                when (it) {
                    ...
                    is ApiResult.Success -> {
                        ...
                        if (_rates != null) {
                            ...
                            _events.value = SettingsContract.Events.ShowError("The Currency couldn't be saved")
                        }
                    }
                }
            }
