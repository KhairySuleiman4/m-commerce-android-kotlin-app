...
class AddressesRemoteDataSourceImp(
    ...
    override fun addAddress(accessToken: String, address: AddressEntity): Flow<ApiResult<Boolean>> = executeAPI {
        val result = graphQLService.addAddress(accessToken,address.toModel()).data
