...
class CategoriesRepoImpl(private val categoriesRemoteDataSource: CategoriesRemoteDataSource) :
    CategoriesRepo {
    override suspend fun fetchCategories(): Flow<ApiResult<List<CategoriesEntity>>> =
